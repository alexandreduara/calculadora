# Olá! :raising_hand: Neste projeto eu criei uma calculadora usando JavaScript puro! 

<br>

## [Deploy do Website - dê uma olhada em como ficou o site :wink: ](https://alexandreduara.github.io/calculadora/)
<br>

## Um GIF Rápido mostrando o projeto já finalizado :space_invader:
![Um Gif rápido mostrando o projeto](./assets/img/)


## Neste projeto eu :books:
- ### Aprendi muitas funções de Javascript, e percebi que muito dele se assemelha ao python, e outras linguagens, com somente algumas especificidades!
...
- ### Implementar o JavaScript na calculadora e deixar ela funcional.
- ### Estudar e ao mesmo tempo aplicar meus conhecimentos adquiridos.
- ### Fazer o navegador ler por último o JavaScript.
